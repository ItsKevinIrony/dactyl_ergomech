# Dactyl ZMK Ergomech Store Guide

This is the keymap for the Dactyl Wireless build by Ergomech Store

This guide is for flashing the Ergomech Dactyl keyboard.

The Ergomech Dactyl Wireless uses a Nice!Nano microcontroller and runs the ZMK firmware. This guide will show you how to flash the ZMK firmware to the Nice!Nano microcontroller.
...
However, Ergomech has already done this for you. You can find the repository [here](https://github.com/ergomechstore/dactyl_ergomech). Assuming you already have a GitHub account,
...
file (i.e. the right side with the `dactyl_right-nice_nano_v2-zmk.uf2` file), you may find it helpful to follow the following order:
...
#### Modifying the keymap with the keymap editor (not yet supported)
